...
/**
 * Unit tests for local_backup_gateway
 *
...
require_once($CFG->dirroot . '/local/backup_gateway/externallib.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class local_backup_gateway_testcase extends externallib_advanced_testcase {
    /**
    ...
    public function test_find_courses() {
        ...
        $results = local_backup_gateway_external::find_courses('test');
    ...
    public function test_get_course_backup_by_id() {
        ...
        $result = local_backup_gateway_external::get_course_backup_by_id($c1->id, $user->username);
